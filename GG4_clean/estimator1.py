...
def run_em(
    ...
    freeze_Q_iters: int = 100# freeze Q for first 20 iters
    freeze_R_iters: int = 100 # freeze R for first 20 iters
    ...
    for it in range(n_iter):
        ...
        if sparse:
            ...
            lam_this_iter = lam_warmup if it < 0 else lam_input
...
def fit(
    ...
    print('A after em')
    eigs = np.linalg.eigvals(params.A)
