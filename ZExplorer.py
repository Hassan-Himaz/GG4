...
class Explorer:
    ...
    """
    OLD simulator class that has the explorer method which i want to stop using
    """

    def __init__(self,parameters:LDSParams|None,illustrator: Illustrator,simulator:Simulator):
        """
        ...
        explorer = Explorer(params,illustrator,controller,simulator)   
        explorer.explore()
        ...
        self.controller = self.simulator.make_pulse(0,20,20,2)   #input
